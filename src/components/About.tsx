	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogContent className="sm:max-w-[600px]">
				...
				<div className="vertical text-sm gap-2">
					<p>
						Climate change is increasing the risk of disasters. STORM (Strategic Thompson-sampling Optimized Resource Management) is a disaster relief simulation that demonstrates using
						probability to optimize disaster relief resource allocation.
					</p>
					<p>
